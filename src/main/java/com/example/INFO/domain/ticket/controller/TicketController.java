...
public class TicketController {
    ...
    public List<TicketResponse> getSortedByDiscountRateDesc(
        ...
        return ticketService.getSortedByDiscountRateDesc(page, size);
    }
    ...
    public List<TicketResponse> getSortedByStartDateDesc(
            @RequestParam(defaultValue = "0") int page,
            @RequestParam(defaultValue = "10") int size) {
        return ticketService.getSortedByStartDateDesc(page, size);
    }
    ...
    public List<TicketResponse> getSortedByEndDate(
            @RequestParam(defaultValue = "0") int page,
            @RequestParam(defaultValue = "10") int size) {
        return ticketService.getSortedByEndDateClosestToToday(page, size);
    }
    //  공연장 필터링
    ...
    public List<TicketResponse> filterByPlaces(
            @RequestBody TicketPlaceFilterRequest request,
            @RequestParam(defaultValue = "0") int page,
            @RequestParam(defaultValue = "10") int size) {
        return ticketService.filterByPlaces(request.getPlaces(), page, size);
    }
    ...
    public List<TicketResponse> filterByAreas(
            @RequestBody TicketAreasFilterRequest request,
            @RequestParam(defaultValue = "0") int page,
            @RequestParam(defaultValue = "10") int size) {
        return ticketService.filterByAreas(request.getAreas(), page, size);
    }
